  ...
  export const gridItems = [
    {
      ...
      description: "Gör det hetsigt",
      className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh]",
      imgClassName: "w-full h-full",
      titleClassName: "justify-end",
      img: "/assets/bento4.jpg",
      spareImg: "",
    },
    {
      id: 2,
      title: "Spela flera unika spel",
      description: "Testa nytt",
    ...
    },
    {
      ...
      description: "Spela närsom!",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
      titleClassName: "",
      img: "/assets/bento6.jpg",
      spareImg: "",
    },
    {
      id: 4,
...
export const perks = [
    {
        icon: Icons.auth,
        title: "blorem",
        info: "lorem ipsum dolor lorem selar.",
    },
    {
        icon: Icons.customize,
        title: "ipsum",
        info: "ipsum lorem dolor lorem dolor.",
    },
    {
        icon: Icons.launch,
        title: "dolor",
        info: "ipsum dolor lorem dolor ipsum.",
    },
];
