...
const MagicButton = ({
    ...
    return (
        <button className="relative inline-flex h-[5vh] md:h-[10vh] lg:h-12 mt-5 min-w-[150px] md:min-w-[200px] overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-auto flex-grow">
