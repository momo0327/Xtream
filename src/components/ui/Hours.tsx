      ...
      <div className="flex flex-col md:flex-row justify-center gap-6">
        ...
        <div className="w-full h-[30vh] md:w-1/3 p-6 bg-neutral-950/60 rounded-lg flex items-center justify-center border border-white/10">
          <ul className="space-y-4 text-center">
            <li className="text-l font-semibold bg-gradient-to-r from-red-700 to-red-200 text-transparent bg-clip-text">
              Söndag - Torsdag:
            </li>
            <li className=" text-4xl font-bold bg-clip-text bg-gradient-to-b from-white to-gray-400 text-transparent">
              Kl 12:00 - 00:00 
            </li>
          </ul>
        </div>
