...
const Footer = () => {
    return (
        <footer className="flex flex-col relative items-center justify-center border-t border-neutral-800/90 pt-16 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32">
            ...
            <div className="grid gap-8 xl:grid-cols-3 xl:gap-8 w-full">
                ...
                <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                    ...
                    Developed by Zenit Digital Studios                    </p>
                    <span className="mt-4 text-neutral-400 text-sm flex items-center w-full">
